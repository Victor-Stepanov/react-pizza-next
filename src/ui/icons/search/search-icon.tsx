  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.4472 15.4463C15.6425 15.251 15.9591 15.251 16.1543 15.4463L21.3543 20.6463C21.5496 20.8415 21.5496 21.1581 21.3543 21.3534C21.1591 21.5486 20.8425 21.5486 20.6472 21.3534L15.4472 16.1534C15.252 15.9581 15.252 15.6415 15.4472 15.4463Z"
        fill="#414141"
      />
    </svg>
  );
